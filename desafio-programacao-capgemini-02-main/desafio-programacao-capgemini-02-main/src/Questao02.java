...
public class Questao02 {
    public static void main(String[] args) {
        ...
        int[] vetor = new int[5]; // Criaçã do vetor.
        ...
        // Cada valor do vetor será comparado com todos os valores a sua frente no intuito de encontrar os pares de valores cujo a diferença é igual a "x".
